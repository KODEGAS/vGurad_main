...
const detection_result_routes_1 = __importDefault(require("./routes/detection-result.routes"));
const note_routes_1 = __importDefault(require("./routes/note.routes"));
const weatherAlert_routes_1 = __importDefault(require("./routes/weatherAlert.routes"));
const crop_analysis_proxy_routes_1 = __importDefault(require("./routes/crop-analysis-proxy.routes"));
...
app.use('/api/users', verifyAndFetchUser, user_routes_1.default);
...
app.use('/api/detection-results', detection_result_routes_1.default);
app.use('/api/notes', note_routes_1.default);
app.use('/api/weather-alerts', weatherAlert_routes_1.default);
app.use('/api/crop-analysis', crop_analysis_proxy_routes_1.default);
app.listen(PORT, () => {
