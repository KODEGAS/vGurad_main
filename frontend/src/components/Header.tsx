    ...
    <header className="bg-gradient-to-r from-primary to-crop-primary text-white p-4 shadow-card">
      <div className="container mx-auto flex items-center justify-between max-w-full">
        ...
        <div className="flex items-center gap-1 md:gap-3 flex-wrap">
          <Link to="/market-prices" className="hidden sm:block">
          ...
          {userProfile && userProfile.role === 'admin' && !profileLoading && (
            <Button
              variant="ghost"
              size="sm"
              className="bg-white/10 border-white/20 text-white hover:bg-white/20 text-xs md:text-sm px-2 md:px-4 hidden md:block"
            ...
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem className="sm:hidden" onClick={() => navigate('/market-prices')}>
