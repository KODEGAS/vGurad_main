...
export const AuthDialog: React.FC<AuthDialogProps> = ({ children, open: controlledOpen, onOpenChange: controlledOnOpenChange }) => {
    ...
    // If children are provided, render with trigger
    if (children) {
        return (
