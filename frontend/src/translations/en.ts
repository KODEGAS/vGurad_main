export const translations = {
  ...
  marketPricesDescription: "Real-time market prices for various rice varieties across Sri Lanka",
  ...
  pricesDisclaimer: "Prices are indicative and may vary based on quality, quantity, and market conditions. Please verify current rates with local traders before making transactions.",
