...
const Index = () => {
  ...
  const renderCurrentPage = () => {
    if (isPageLoading) {
      return <SectionLoadingSpinner text="Loading page..." />;
    }

    switch (currentPage) {
      case 'scanner':
        return (
          <Suspense fallback={<SectionLoadingSpinner text="Loading crop scanner..." />}>
            <CropScanner onBack={() => handlePageChange('home')} />
          </Suspense>
        );
      case 'database':
        return (
          <Suspense fallback={<SectionLoadingSpinner text="Loading disease database..." />}>
            <DiseaseDatabase onBack={() => handlePageChange('home')} />
          </Suspense>
        );
      case 'tips':
        return (
          <Suspense fallback={<SectionLoadingSpinner text="Loading farmer tips..." />}>
            <FarmerTips onBack={() => handlePageChange('home')} />
          </Suspense>
        );
      case 'help':
        return (
          <Suspense fallback={<SectionLoadingSpinner text="Loading expert help..." />}>
      ...
      case 'chat':
        return (
          <Suspense fallback={<SectionLoadingSpinner text="Loading chat..." />}>
          ...
          <div className="space-y-8 page-transition">
            ...
            {/* Quick Stats */}
              ...
              <Card className="bg-gradient-to-br from-success/10 to-success/5 border-success/20 hover-lift animate-stagger-1">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-xs text-muted-foreground">Diseases Detected</div>
                </CardContent>
              </Card>
            ...
            {/* Main Actions */}
              ...
              <QuickActionCard
                ...
                description="Take a photo to detect diseases and get instant treatment recommendations"
                icon={Camera}
              ...
              <QuickActionCard
                ...
                description="Browse comprehensive information about crop diseases and treatments"
                icon={BookOpen}
            ...
            {/* Secondary Actions */}
              ...
              <QuickActionCard
                title="Farmer Tips"
                description="Get seasonal advice, weather alerts, and expert farming tips"
                icon={Lightbulb}
              ...
              <QuickActionCard
                title="Expert Help"
                description="Connect with agricultural experts for personalized assistance"
                icon={Phone}
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {currentPage === 'home' && <ChatBot onStartChat={undefined} />}
    </div>
  );
};
